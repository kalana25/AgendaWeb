...
namespace AgendaWeb.DAL.Migrations
{
    ...
    [Migration("20190918163458_ResourceWithRelationship")]
    partial class ResourceWithRelationship
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AgendaWeb.Models.Resource", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("AgendaWeb.Models.ResourceResourceProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.ToTable("ResourceResourceProfiles");
                });
            ...
            modelBuilder.Entity("AgendaWeb.Models.Resource", b =>
                {
                    b.HasOne("AgendaWeb.Models.Collaborator", "Collaborator")
                        .WithOne("Resource")
                        .HasForeignKey("AgendaWeb.Models.Resource", "CollaboratorId")
                        .OnDelete(DeleteBehavior.Cascade);
            ...
            modelBuilder.Entity("AgendaWeb.Models.ResourceResourceProfile", b =>
                {
                    b.HasOne("AgendaWeb.Models.Resource", "Resource")
                        .WithMany("ResourceResourceProfiles")
